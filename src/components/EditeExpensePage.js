...
import { editeExpense, removeExpense } from "../actions/expneses";
...
const mapDispatchToProps = (dispatch) => (
    {
        modifieExpense: (id, expense) => dispatch(editeExpense(id, expense)),
        onButtonClick: (id)=> dispatch(removeExpense(id))
    }
)
